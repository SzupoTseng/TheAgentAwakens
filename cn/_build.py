...
COVER = os.path.join(os.path.dirname(BOOK), "TheAgentAwakens.png")  # 封面在仓库根目录

BOOK_TITLE = "代理觉醒"
BOOK_SUB   = "龙虾 OpenClaw 与 Hermes Agent，以及 SRE／Fab／Lab 实战百景"
...
def build_merged():
    ...
    if os.path.exists(COVER):
        parts.append("![代理觉醒 · The Agent Awakens — 封面海报](../TheAgentAwakens.png)\n")
    parts.append("> 全书合并版。简体中文版由繁体中文版以 OpenCC(tw2sp) 转换生成。\n")
    parts.append("\n---\n\n## 目录\n")
    for base in FILES:
